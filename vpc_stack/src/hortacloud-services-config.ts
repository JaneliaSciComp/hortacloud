...
const defaultJacsStackVersion = "9.23.RC4";

// Horta Services Config
export interface HortaCloudServicesConfig
  extends HortaCloudConfig,
    HortaBackupConfig {
...
export function getHortaServicesConfig(): HortaCloudServicesConfig {
  const hortaSystemVolumeSizeGB: number = process.env
    .HORTA_SERVER_SYSTEM_VOLSIZE_GB
  ...
  return {
    ...getHortaCloudConfig(),
    ...getHortaBackupConfig(),
    hortaServerInstanceType:
      process.env.HORTA_SERVER_INSTANCE_TYPE || "r5n.2xlarge",
    ...
    jwtKey:
      process.env.JACS_JWT_KEY || "GFNaVyaC6boqf0VKtBEjLLu5VY8Ks0PQ23kpSs8lgWg",
    mongoKey:
      process.env.JACS_MONGO_KEY || "C9w7ZIVbtvN4LqDgOUrZuLEOqGSkgjWvRDg4mpgDw",
