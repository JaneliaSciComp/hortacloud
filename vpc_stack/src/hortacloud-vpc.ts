...
export class HortaCloudVPC extends Stack {
  ...
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    ssmIE.connections.allowFrom(
      ssmPrivateSG,
      Port.tcp(443),
      "Allow from SSM IE Private SG"
    );
    ...
    ssmMessagesIE.connections.allowFrom(
      ssmPrivateSG,
      Port.tcp(443),
      "Allow from SSM Messages IE Private SG"
    );
    ...
    ec2IE.connections.allowFrom(
      ssmPrivateSG,
      Port.tcp(443),
      "Allow from EC2 IE Private SG"
    );
    ...
    ec2Messages.connections.allowFrom(
      ssmPrivateSG,
      Port.tcp(443),
      "Allow from EC2 Messages IE Private SG"
    );
