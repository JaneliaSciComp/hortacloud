  ...
  constructor(scope: Construct, id: string) {
    ...
    this.pool = new cognito.UserPool(this, "HortaCloudUsers", {
      ...
      userInvitation: {
        ...
        emailBody: `Hello {username}, you have been invited to work with our HortaCloud service. <br/>
        Your temporary password is '{####}'.<br/>
        Please login at ${adminBucketUrl}`,
        smsMessage:
          "Hello {username}, you have been invited to work with our HortaCloud service. Your temporary password is '{####}'."
      },
    ...
    const adminGroup = new cognito.CfnUserPoolGroup(
      this,
      "AdminsUserPoolGroup",
      {
    ...
    if (process.env.ADMIN_USER_EMAIL) {
      ...
      const attachAdminUser = new cognito.CfnUserPoolUserToGroupAttachment(
        this,
